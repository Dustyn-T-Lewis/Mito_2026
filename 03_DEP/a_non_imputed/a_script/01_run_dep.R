...
#   ~ 0 + group + (1 | Replicate), group {Ctl, Mito, PHE, PHE_Mito}; 6 factorial contrasts.
#   Significance: Pi-score (Xiao 2014, Pi = P.Value^|logFC|) < 0.05 primary; BH-FDR (proteoDA adj.P.Val) reported alongside.
