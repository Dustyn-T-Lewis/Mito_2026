...
source(here::here("04_Figures", "F03_concordance", "a_script", "01_main_panels.R"))
source(here::here("04_Figures", "shared", "figure_supplement_helpers.R"))

DAT <- here::here("04_Figures", "F03_concordance", "c_data")
f03_specs <- list(
...
if (nzchar(box) && dir.exists(box)) {
  RPT <- here::here("04_Figures", "F03_concordance", "b_reports")
