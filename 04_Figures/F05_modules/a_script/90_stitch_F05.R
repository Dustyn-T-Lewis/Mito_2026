...
source(here::here("04_Figures", "F05_modules", "a_script", "01_set_scores.R"))
source(here::here("04_Figures", "F05_modules", "a_script", "02_main_panels.R"))
source(here::here("04_Figures", "shared", "build_wgcna_network.R"))
source(here::here("04_Figures", "F05_modules", "a_script", "91_wgcna_supp.R"))

box <- Sys.getenv("H9C2_BOX_DIR", "")
if (nzchar(box) && dir.exists(box)) {
  RPT <- here::here("04_Figures", "F05_modules", "b_reports")
