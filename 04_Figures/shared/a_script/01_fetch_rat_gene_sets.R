...
# See the README (Gene Sets and Provenance).
...
kegg <- msig_block("C2", "CP:KEGG_LEGACY") # legacy KEGG for continuity; MEDICUS is the newer curation
...
attr(sets, "provenance") <- list(
  ...
  godb_version = as.character(packageVersion("GO.db")),
  orgdb_version = as.character(packageVersion("org.Rn.eg.db")),
