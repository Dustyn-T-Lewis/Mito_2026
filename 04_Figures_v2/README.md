...
- **Group colours** (Ctl=#3B7DB5, Mito=#009E73, PHE=#E08214, PHE_Mito=#8073AC) match `GROUP_COLORS` in `01_style_palettes_theme.R`. Contrast **role names** (Disease / Transplant / Rescue / Secondary / Interaction) come from `CONTRAST_ROLES` and are used on axis labels, bar fills, and panel titles throughout.
