# 04_Figures_v2/functions/06_supplementary_workbook.R
...
# workbook (no redundant loose CSVs) — the lone exception a figure may keep on
# disk is a CSV that a DOWNSTREAM script consumes (e.g. shown_pathways.csv for the
# cluster figure). This builder never deletes anything.
